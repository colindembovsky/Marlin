...
#define EXTRUDER_AUTO_FAN_SPEED 127 //CD   // 255 == full speed
...
#define LIN_ADVANCE //CD
    ...
    #define ADVANCE_K { 0.14 }    //CD (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.14        //CD (mm) Compression length applying to all extruders
  #endif
