...
#define STRING_CONFIG_H_AUTHOR "(colind, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Col's Ender-3"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79, 79, 400, 96 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -3, -2.38 }
...
#define HOMING_FEEDRATE_Z  (2*4*60)
