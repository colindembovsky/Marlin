...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  25.26  //CD
    #define DEFAULT_Ki   2.35  //CD
    #define DEFAULT_Kd  67.80  //CD
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -3, -2.36 } //CD
...
#define XY_PROBE_FEEDRATE (133*60*2)  //CD
...
#define INVERT_Y_DIR true //CD
#define INVERT_Z_DIR false //CD
...
#define HOMING_FEEDRATE_MM_M { (20*60), (20*60), (8*60) }  //CD
...
#define PREHEAT_2_FAN_SPEED   67 // Value from 0 to 255
